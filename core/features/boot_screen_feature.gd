# ==============================================================================
# Taj's Core - Boot Screen Feature
# Author: TajemnikTV
# Description: Appends Taj's Core branding after vanilla boot text displays
# ==============================================================================
extends RefCounted

const LOG_NAME := "TajemnikTV-Core:BootScreen"
const APPEND_DELAY := 0.5 # Seconds to wait for vanilla text before appending
